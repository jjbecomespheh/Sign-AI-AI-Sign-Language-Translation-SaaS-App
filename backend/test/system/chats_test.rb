...
class ChatsTest < ApplicationSystemTestCase
  ...
  test "creating a Chat" do
    ...
    fill_in "Conversation", with: @chat.conversation_id
    fill_in "Created at", with: @chat.created_at
    fill_in "Id", with: @chat.id
    fill_in "Message", with: @chat.message
    fill_in "Sender", with: @chat.sender
    fill_in "Updated at", with: @chat.updated_at
